...
export const FooterSection = (): JSX.Element => {
 const navigationLinks = [
  { text: "Tenderët", separator: "/" },
  { text: "Pakot", separator: "/" },
  { text: "Kontakto", separator: "/" },
  { text: "Abonohu", separator: "/" },
 ];
    ...
    <div className="hidden lg:flex items-end gap-6">
     <div className="flex flex-col items-start gap-32 flex-1">
      <div className="relative w-[180px] h-[170px]">
       <img className="absolute top-0 left-0 w-[33px] h-10" alt="Group" src="/group-1321316878-1.png" />
        ...
        <div className="inline-flex items-start gap-4 flex-[0_0_auto]">
         {navigationLinks.slice(0, 2).map((link, index) => (
          <React.Fragment key={index}>
           <Button
            variant="ghost"
            className="h-auto p-0 [font-family:'Inter',Helvetica] font-medium text-[#1b2631] text-sm tracking-[0] leading-[19.6px] whitespace-nowrap hover:bg-transparent"
           >
            {link.text}
           </Button>
    ...
    <div className="lg:hidden">
     <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
      ...
      <div className="flex flex-col items-start">
       <img className="w-[33px] h-10 mb-6" alt="Group" src="/group-1321316878-1.png" />
       ...
       <nav className="flex flex-col gap-2">
        {navigationLinks.map((link, index) => (
         <Button
          key={index}
          variant="ghost"
          className="h-auto p-0 text-left justify-start font-medium text-[#1b2631] text-sm hover:text-[#f0c419] hover:bg-transparent"
         >
          {link.text}
         </Button>
        ))}
      ...
      <div className="flex flex-col items-start">
       ...
       <div>
        ...
        <div className="flex flex-col gap-2">
         {socialMediaLinks.map((social, index) => (
          <Button key={index} variant="ghost" className="h-auto p-0 flex items-center gap-2 justify-start hover:bg-transparent hover:text-[#f0c419]">
